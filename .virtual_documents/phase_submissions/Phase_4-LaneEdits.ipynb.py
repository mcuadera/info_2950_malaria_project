...
plt.xlabel("GDP Per Capita PPP (UNITS?get_ipython().getoutput("?!)")")
plt.ylabel("Count")
plt.show()
...
plt.xlabel("Development Status")
plt.ylabel("GDP Per Capita PPP (UNITS?get_ipython().getoutput("?!)")")
...
plt.scatter(year_2013["Incidence"],year_2013["GDPpcPPP"])
